...
<link type="text/css" rel="stylesheet" href='https://www.innovativeprogramming.org/stevenschessclub.com/resources/display.css' />
        <?php echo "<style>".file_get_contents("../resources/aboutCSS.txt")."</style>"; ?>
    </head>
    <body>
        <main class='home'>
        <script type="application/ld+json"> { 
            ...
            <nav class='chess'>
                <table> 
                    <tr class='nav'>
                        <td class='nav'><a class='nav' href='https://www.stevenschessclub.com/'>Home<span class='nav'></span></a></td>
                        <td class='nav'><a class='nav' href='http://www.stevenschessclub.com/about'>About<span class='nav'></span></a></td>
                        <td class='nav'><a class='nav' href='https://www.stevenschessclub.com/events'>Events<span class='nav'></span></a></td>
                        <td class='nav'><a class='nav' href='https://orgsync.com/50809/chapter'>Join Us<span class='nav'></span></a></td>
                        <td class='nav'><a class='nav' href='https://www.stevenschessclub.com/login'>Member's Portal<span class='nav'></span></a></td>
                    </tr>
                </table>
            </nav>
        </div>
            <?php echo file_get_contents("../resources/aboutHTML.txt");  ?>
             <div class='bottom'>
